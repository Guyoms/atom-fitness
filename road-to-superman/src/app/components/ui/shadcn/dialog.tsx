...
import { CloseCircleIcon } from "@/components/ui/icons/icons"
...
>(({ className, children, ...props }, ref) => (
  <Portal>
    ...
    >
      {children}
      <Close className="absolute right-4 top-4 z-10 rounded-full opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
